...
export const metadata: Metadata = {
  title: 'Услуги - TechnoMart',
  description: 'Услуги TechnoMart: доставка, установка, настройка, техническое обслуживание техники. Профессиональные услуги.',
}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Полный спектр услуг для вашей техники - от доставки до обслуживания
            </p>
            <Button size="lg">
              ...
              <div>
                <form className="space-y-6">
                  ...
                  <select className="w-full p-3 border rounded-lg bg-white text-black">
                    ...
                    <option>Доставка и установка</option>
                    <option>Техническое обслуживание</option>
                    <option>Расширенная гарантия</option>
                    <option>Консультации и обучение</option>
                  </select>
                  <textarea 
                    rows={4}
