...
import { Plus, Package, Tags, Users, BarChart3, RefreshCw } from 'lucide-react'
import { Button } from '@/components/ui/Button'
import Link from 'next/link'

// Убираем export для metadata в клиентском компоненте
// export const metadata: Metadata = {
//   title: 'Админ-панель - TechnoMart',
  ...
  const fetchStats = async () => {
    ...
    try {
      ...
      setStats({
        ...
        orders: 0, // TODO: добавить API для заказов
        users: 0   // TODO: добавить API для пользователей
      })
    } catch (error) {
