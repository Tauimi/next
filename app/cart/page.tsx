  ...
  const loadCart = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setCartItems(data.success ? data.data.items : [])
      } else {
    ...
    <div className="container-custom py-8">
      <div className="mb-8">
        ...
        <p className="text-secondary-600">
          {getTotalItems()} товар(ов) на сумму {getTotalAmount().toLocaleString()} ₽
        </p>
      </div>
          ...
          <div className="card sticky top-8">
            ...
            <div className="space-y-3 mb-6">
              <div className="flex justify-between">
                <span className="text-secondary-600">Товары ({getTotalItems()})</span>
