        ...
        <div className="flex items-center justify-between py-4">
          ...
          <Link href="/" className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              <h1 className="font-bold text-xl text-primary">TechnoMart</h1>
              <p className="text-xs text-muted-foreground">Электроника и техника</p>
            </div>
          </Link>
            ...
            <nav className="container mx-auto px-4 py-4">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  href={item.href}
                  className="block py-3 text-foreground hover:text-primary transition-colors border-b last:border-0"
